          ...
          <div>
            ...
            <form onSubmit={handleSubmit()}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="mt-8 mx-8 w-[calc(100%-4rem)] py-3 bg-transparent border-2 border-[#2C5F5D] text-[#2C5F5D] font-semibold rounded-md tracking-wider uppercase transition-all duration-300 shadow-md relative overflow-hidden group hover:border-[#C9A961] hover:text-white disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="flex justify-center items-center gap-4 mx-8">
              <button
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-2 border border-gray-300 hover:border-[#C9A961] px-8 py-3 rounded-lg transition-all flex-1 relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <span className="absolute top-0 left-0 w-0 h-full bg-[#C9A961] transition-all duration-300 ease-out group-hover:w-full"></span>
                <img
                  src={gmail}
