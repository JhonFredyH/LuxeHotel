          ...
          <div className="p-4 sm:p-6 pb-8 sm:pb-10 space-y-5 sm:space-y-6">
            ...
            <div className={`border-t pt-5 sm:pt-6 ${isDark ? "border-slate-700" : "border-slate-200"}`}>
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className={`mt-1 text-[clamp(0.9rem,0.84rem+0.2vw,1rem)] ${isDark ? "text-slate-200" : "text-slate-700"}`}>
                    {reservation.guest}
                  </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className={`mt-2 space-y-1 text-[clamp(0.78rem,0.74rem+0.2vw,0.9rem)] ${isDark ? "text-slate-400" : "text-slate-600"}`}>
                    <p>🛏️ {reservation.beds || '2 queen beds'}</p>
                    <p>👥 {reservation.capacity || 'Max 4 guests'}</p>                    
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`border-t pt-5 sm:pt-6 ${isDark ? "border-slate-700" : "border-slate-200"}`}>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <button 
                  onClick={handlePrint}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition"
                >
