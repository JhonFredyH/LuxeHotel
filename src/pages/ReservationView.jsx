...
import { CreditCard, Wallet, Shield, DollarSign, User, Lock } from "lucide-react";
...
const ReservationView = () => {
  ...
  const selectedRoom = bookingState.room ?? allRooms[0];
  ...
  const nights = useMemo(() => {
    ...
    const diff = new Date(reservationData.checkOut) - new Date(reservationData.checkIn);
      ...
      <div className="mx-auto max-w-[1500px]">
        <header className="relative flex items-start justify-between gap-4 px-2 py-2 sm:px-4 sm:py-4">
          ...
          <div className="hidden lg:block absolute left-1/2 top-1/2 max-w-3xl -translate-x-1/2 -translate-y-1/2 px-2 text-center">
            <h1 id="reservation-title" className="mb-2 text-[clamp(1.8rem,4.6vw,3rem)] font-bold text-slate-900">Complete Your Reservation</h1>
            <p className="text-[clamp(0.95rem,2.3vw,1.2rem)] text-slate-700">
              Final step: Secure your stay at our <span className="font-semibold">{selectedRoom.name}</span>.
            </p>
          </div>
        ...
        <div className="mt-3 px-2 text-center lg:hidden">
          <h1 className="mb-2 text-[clamp(1.8rem,4.6vw,3rem)] font-bold text-slate-900">Complete Your Reservation</h1>
          <p className="text-[clamp(0.95rem,2.3vw,1.2rem)] text-slate-700">
            Final step: Secure your stay at our <span className="font-semibold">{selectedRoom.name}</span>.
          </p>
        </div>
        ...
        >
          ...
          <section className="space-y-8">
            <div className="space-y-6">
              <div className="mb-6 flex items-center gap-2">
                <div className="flex h-5 w-5 items-center justify-center rounded bg-slate-700" aria-hidden="true">
                  <User className="h-3 w-3 text-white" />
                </div>
                <h2 className="text-[clamp(1.05rem,2vw,1.25rem)] font-bold text-slate-800">Guest Information</h2>
              </div>
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8">
                <div className="space-y-1">
                  <label htmlFor="fullName" className={`block text-xs font-semibold uppercase tracking-wide ${errors.fullName ? "text-red-600" : "text-slate-700"}`}>Full Name</label>
                  <input
                    id="fullName"
                    name="fullName"
                    type="text"
                    ...
                    onBlur={(e) => validateFieldOnBlur("fullName", e.target.value)}
                  ...
                  />
                  {errors.fullName && <p id="fullName-error" role="alert" className="mt-1 text-xs text-red-600">{errors.fullName}</p>}
                </div>

                <div className="space-y-1">
                  <label htmlFor="email" className={`block text-xs font-semibold uppercase tracking-wide ${errors.email ? "text-red-600" : "text-slate-700"}`}>Email Address</label>
                  <input
                    id="email"
                    name="email"
                    type="email"
              ...
              <div className="mt-6 space-y-1">
                <label htmlFor="phone" className={`block text-xs font-semibold uppercase tracking-wide ${errors.phone ? "text-red-600" : "text-slate-700"}`}>Phone Number</label>
                <input
                  id="phone"
                  name="phone"
                  type="tel"
            ...
            <div className="space-y-6">
              <div className="mb-6 flex items-center gap-2">
                ...
                <h2 className="text-[clamp(1.05rem,2vw,1.25rem)] font-bold text-slate-800">Payment Method</h2>
              </div>

              <div className="mb-8 grid grid-cols-2 gap-3" role="group" aria-label="Select payment method">
                <button
                  type="button"
              ...
              {paymentMethod === "card" && (
                <div className="space-y-6">
                  <div className="space-y-1">
                    <label htmlFor="cardholderName" className={`block text-xs font-semibold uppercase tracking-wide ${errors.cardholderName ? "text-red-600" : "text-slate-700"}`}>Cardholder Name</label>
                    <input
                      id="cardholderName"
                      name="cardholderName"
                      type="text"
                      ...
                      onChange={handleInputChange}
                      onBlur={(e) => validateFieldOnBlur("cardholderName", e.target.value)}
                    ...
                    />
                    {errors.cardholderName && <p id="cardholderName-error" role="alert" className="mt-1 text-xs text-red-600">{errors.cardholderName}</p>}
                  </div>
                  <div className="space-y-1">
                    <label htmlFor="cardNumber" className={`block text-xs font-semibold uppercase tracking-wide ${errors.cardNumber ? "text-red-600" : "text-slate-700"}`}>Card Number</label>
                    <input
                      id="cardNumber"
                      name="cardNumber"
                      type="text"
                      ...
                      onChange={handleInputChange}
                      onBlur={(e) => validateFieldOnBlur("cardNumber", e.target.value)}
                    ...
                    />
                    {errors.cardNumber && <p id="cardNumber-error" role="alert" className="mt-1 text-xs text-red-600">{errors.cardNumber}</p>}
                  </div>

                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-8">
                    <div className="space-y-1">
                      <label htmlFor="expiry" className={`block text-xs font-semibold uppercase tracking-wide ${errors.expiry ? "text-red-600" : "text-slate-700"}`}>Expiry (MM/YY)</label>
                      <input
                        id="expiry"
                        name="expiry"
                        type="text"
                        ...
                        onChange={handleInputChange}
                        onBlur={(e) => validateFieldOnBlur("expiry", e.target.value)}
                        ...
                        placeholder="MM/YY"
                      />
                      {errors.expiry && <p id="expiry-error" role="alert" className="mt-1 text-xs text-red-600">{errors.expiry}</p>}
                    </div>

                    <div className="space-y-1">
                      <label htmlFor="cvc" className={`block text-xs font-semibold uppercase tracking-wide ${errors.cvc ? "text-red-600" : "text-slate-700"}`}>CVC</label>
                      <input
                        id="cvc"
                        name="cvc"
                        type="text"
                        ...
                        value={formData.cvc}
                        onChange={handleInputChange}
                        onBlur={(e) => validateFieldOnBlur("cvc", e.target.value)}
                        ...
                        placeholder="123"
                      />
                      {errors.cvc && <p id="cvc-error" role="alert" className="mt-1 text-xs text-red-600">{errors.cvc}</p>}
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="space-y-4">
              <h2 className="text-[clamp(1.05rem,2vw,1.25rem)] font-bold text-slate-800">Special Requests (Optional)</h2>
              <div className="space-y-2">
                <label htmlFor="specialRequests" className={`block text-xs font-semibold uppercase tracking-wide ${errors.specialRequests ? "text-red-600" : "text-slate-700"}`}>Special Requests</label>
                <textarea
                  id="specialRequests"
                  ...
                  onChange={handleInputChange}
                  onBlur={(e) => validateFieldOnBlur("specialRequests", e.target.value)}
                  aria-invalid={Boolean(errors.specialRequests)}
                  aria-describedby={errors.specialRequests ? "specialRequests-error specialRequests-help" : "specialRequests-help"}
                ...
                />
                {errors.specialRequests && <p id="specialRequests-error" role="alert" className="mt-1 text-xs text-red-600">{errors.specialRequests}</p>}
          ...
          <aside className="space-y-6">
            {/* Progress bar */}
            <section className="text-right" aria-live="polite" aria-label="Booking progress">
              <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-slate-600">Step 3 of 3</div>
              <div className="text-2xl font-bold text-teal-700">{completionPercent}%</div>
              <div
              ...
              >
                <div className="h-full rounded-full bg-teal-600 transition-all duration-500" style={{ width: `${completionPercent}%` }}></div>
              </div>
            </section>

            {/* Room summary card */}
            <section className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg">
              <img src={selectedRoomCover} alt={`${selectedRoom.name} room`} className="h-64 w-full object-cover" />

              <div className="space-y-4 p-6">
                <div>
                  <h3 className="mb-1 text-[clamp(1.1rem,2.3vw,1.3rem)] font-bold text-slate-900">{selectedRoom.name}</h3>
                  <p className="text-sm text-slate-700">{selectedRoom.view} view · {selectedRoom.size} m²</p>
                </div>

                <div className="space-y-3 text-sm">
                  <div className="flex justify-between"><span className="text-slate-700">Dates</span><span className="font-semibold text-slate-900">{formattedDates}</span></div>
                  <div className="flex justify-between"><span className="text-slate-700">Duration</span><span className="font-semibold text-slate-900">{nights} {nights === 1 ? "Night" : "Nights"}</span></div>
                  <div className="flex justify-between"><span className="text-slate-700">Guests</span><span className="font-semibold text-slate-900">{adults} Adult{adults > 1 ? "s" : ""}{children > 0 ? `, ${children} Child${children > 1 ? "ren" : ""}` : ""}</span></div>
                </div>

                <div className="space-y-2 border-t border-gray-200 pt-4 text-sm">
                  <div className="flex justify-between"><span className="text-slate-700">Nightly Rate ({currency.format(nightlyRate)} x {nights})</span><span className="font-semibold text-slate-900">{currency.format(nightlyRate * nights)}</span></div>
                  <div className="flex justify-between"><span className="text-slate-700">Cleaning & Service Fee</span><span className="font-semibold text-slate-900">{currency.format(serviceFee)}</span></div>
                  <div className="flex justify-between"><span className="text-slate-700">Taxes</span><span className="font-semibold text-slate-900">{currency.format(taxes)}</span></div>
                </div>

                <div className="border-t-2 border-gray-300 pt-4">
                  <div className="flex items-center justify-between">
                    <span className="text-lg font-bold text-slate-900">Total Price</span>
                    <span className="text-3xl font-bold text-teal-700">{currency.format(totalPrice)}</span>
                  </div>
                </div>
            ...
            <section className="grid grid-cols-2 gap-4">
              <div className="rounded-lg bg-[#008009] p-4 text-center">
                <Shield className="mx-auto mb-2 h-6 w-6 text-white" aria-hidden="true" />
                <div className="text-base font-bold uppercase text-white">Free Cancellation</div>
                <div className="mt-1 text-xs text-white/90">Up to 24h before check-in</div>
              </div>

              <div className="rounded-lg bg-[#003580] p-4 text-center">
                <DollarSign className="mx-auto mb-2 h-6 w-6 text-white" aria-hidden="true" />
                <div className="text-base font-bold uppercase text-white">Best Price Match</div>
                <div className="mt-1 text-xs text-white/90">Guaranteed rate</div>
              </div>
            </section>
          </aside>
        </form>
